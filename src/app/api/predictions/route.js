...
async function processImageGeneration(taskId, userPrompt, image, imageType) {
    try {
        ...
        const currentTask = await updateTask(taskId, "completed", {
            content: fullContent,
            image_url: extractImageUrl(fullContent || image_url)
        });
        ...
        await updateTask(taskId, "failed", { error: error.message });
        throw error;
    }
}
